...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventLog.request_id'
        db.alter_column('ops_eventlog', 'request_id', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'EventLog.request_id'
        db.alter_column('ops_eventlog', 'request_id', self.gf('django.db.models.fields.TextField')())
